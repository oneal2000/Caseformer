...
from dense.data import InferenceDataset, InferenceCollator,CorpusDataset
...
def main():
    ...
    # load inf_dataset
    corpus_dataset = CorpusDataset(data_args.inference_in_path, tokenizer, max_len=mlen)
    corpus_loader_ = DataLoader(
        corpus_dataset,
