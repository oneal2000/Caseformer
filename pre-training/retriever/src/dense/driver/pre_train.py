...
from dense.data import Caseformer_TrainDataset, QPCollator
...
def main():
    ...
    inf_dataset = InferenceDataset(data_args.inference_in_path, tokenizer, max_len=512)
    ...
    train_dataset = Caseformer_TrainDataset(
